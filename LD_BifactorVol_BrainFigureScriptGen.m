...
CorticalGen_Sig = csvread([ProjectFolder '/DesikanGenSig_zscores_header.csv'], 1);
...
V_lh_File = [ProjectFolder '/CortGen_lh.func.gii'];
save(V_lh, V_lh_File);
% rh
...
V_rh_File = [ProjectFolder '/CortGen_rh.func.gii'];
save(V_rh, V_rh_File);
